...
- flush age mode alpha=81 window=[80, 82] (fakes self-identify); f_R_mean=73.3; entangled=False

## Stage B - episode detection
- detected 76 episodes (truth 80.0): P=0.89 R=0.85 F1=0.87 IoU=0.47
- false-positive batches: 0

## Stage C - cardinality
- MAE vs visible target=9.4, median rel err=0.093, worst=0.744
- cached re-read components are invisible (mean undercount vs raw m: -4.9)
