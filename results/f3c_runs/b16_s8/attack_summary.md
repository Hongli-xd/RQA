...
- B_hat=128.0 (truth 128); real budget=112.0 (truth 112); f_D_hat=16 (truth 16)
- flush age mode alpha=81 window=[80, 82] (fakes self-identify); f_R_mean=78.5; entangled=False
