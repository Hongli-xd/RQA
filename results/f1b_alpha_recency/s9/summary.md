...
trace `range_seed9_waffle.tsv`; spike window self-calibrated (bg_mult=4.0); local background half-window 40.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 20 | 79-83 | 1231 | 80 | 0.419 | 0.327 | **0.466** | 0.788 | -0.091 | 0.638 |

## Spike-window robustness (perturbing the attack's own calibration)

| forced window | what it is | E1 ratio rho | E2 excess rho |
| --- | --- | --- | --- |
| 80-82 | narrowed (leaks fakes) | 0.124 | **0.466** |
| 79-83 | self-calibrated | 0.327 | **0.466** |
| 78-84 | widened | 0.414 | **0.466** |
| 75-90 | very wide | 0.414 | **0.466** |
