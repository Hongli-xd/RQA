...
trace `range_seed7_waffle.tsv`; spike window self-calibrated (bg_mult=4.0); local background half-window 40.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 20 | 79-83 | 504 | 24 | 0.869 | 0.844 | **0.836** | 0.779 | -0.091 | 0.597 |
| 30 | 79-83 | 504 | 24 | 0.863 | 0.793 | **0.781** | 0.726 | -0.141 | 0.684 |
| 40 | 79-83 | 504 | 24 | 0.816 | 0.735 | **0.7** | 0.691 | -0.041 | 0.744 |
| 60 | 79-83 | 504 | 24 | 0.65 | 0.435 | **0.316** | 0.328 | -0.146 | 0.776 |

## Spike-window robustness (perturbing the attack's own calibration)

| forced window | what it is | E1 ratio rho | E2 excess rho |
| --- | --- | --- | --- |
| 80-82 | narrowed (leaks fakes) | 0.611 | **0.836** |
| 79-83 | self-calibrated | 0.844 | **0.836** |
| 78-84 | widened | 0.851 | **0.836** |
| 75-90 | very wide | 0.853 | **0.836** |
